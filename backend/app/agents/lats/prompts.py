...
3. 【次选】如果发现 WAF/过滤 → probe_filter → mutate_payload → inject_payload
3. 【次选】如果需要发现隐藏页面/API → crawl_page / render_page / deep_crawl
4. 【次选】如果需要认证测试 → test_no_auth / test_idor
5. 【最后手段】仅当前面所有方法都试过后 → run_poc
